...
@TeleOp(name = "New Arm PID W/ Lifts and Claw", group = "Linear OpMode")
public class NewArmLiftClawTest extends LinearOpMode {
    ...
    // arm pid variables
    private static final double ENCODER_TICKS_PER_REV = 751.8;
    // These values need to be determined during calibration:
    private static final int ENCODER_VALUE_AT_90_DEGREES = 0; // Change this to actual encoder value when arm is vertical
    private static final int MIN_ENCODER_VALUE = 0; // Change to encoder value at -45 degrees
    private static final int MAX_ENCODER_VALUE = 0; // Change to encoder value at 225 degrees
    public static double kP = 0.008;  // Tune
...
//                liftL.setPower(powerApplied);
            ...
            if (gamepad1.y) { // Example preset position
                armTargetPosition = 1000; // Adjust value
