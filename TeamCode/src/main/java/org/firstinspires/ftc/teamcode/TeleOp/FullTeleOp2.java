...
@Config
@TeleOp(name = "Full TeleOp", group = "Working TeleOp")
public class FullTeleOp2 extends LinearOpMode {
...
//        private boolean prevB = false;
    ...
    public static double maxPowerMult = 1; // Set to 1 for full power
    public static double powerChangeSensitivity = 0.25;
